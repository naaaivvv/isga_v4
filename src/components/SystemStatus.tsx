...
const SystemStatus = () => {
  ...
  useEffect(() => {
    const checkConnection = async () => {
      try {
        ...
        const response = await fetch("http://192.168.1.11/isga_v4/php-backend/get_sensor_data.php", {
          method: "GET",
  ...
  const fetchAndHandleSchedule = useCallback(async () => {
    try {
      const response = await fetch("http://192.168.1.11/isga_v4/php-backend/get_schedule.php");
